...
to run_fine_tuning.py to ensure a fair comparison.
"""
...
def main():
    ...
    if os.path.exists(best_weights):
        ...
        src_dst_mappings = [
            ("BoxF1_curve.png", os.path.join(reports_fig_dir, "baseline_F1_curve.png")),
            ("BoxPR_curve.png", os.path.join(reports_fig_dir, "baseline_PR_curve.png")),
            ("confusion_matrix.png", os.path.join(reports_fig_dir, "baseline_confusion_matrix.png")),
            ("results.png", os.path.join(reports_fig_dir, "baseline_results_curve.png")),
            ("results.csv", os.path.join(reports_metric_dir, "baseline_results.csv")),
        ]
        for src_name, dst_path in src_dst_mappings:
            src_path = os.path.join(RUN_DIR, src_name)
            if os.path.exists(src_path):
                shutil.copy(src_path, dst_path)
                print(f"📋 Copied baseline {src_name} -> {dst_path}")
